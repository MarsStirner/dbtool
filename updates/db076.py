...
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='4203' and deleted='0')
...
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='4201' and deleted='0')
...
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='4202' and deleted='0')
...
(select id from ActionType where group_id IN (select id from ActionType where code='1_1' and deleted='0') and deleted=0)
and name="Основной клинический диагноз";
''',
u'''
UPDATE `ActionPropertyType` SET `code`='mainDiag'
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='1_1_01' and deleted='0')
and name="Клиническое описание";
''',
u'''
UPDATE `ActionPropertyType` SET `code`='mainDiag'
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='1_1_02' and deleted='0')
and name="Клиническое описание";
''',
u'''
...
u'''
UPDATE `ActionPropertyType` SET `code`='mainDiag' WHERE `actionType_id` IN 
(select id from ActionType where group_id IN (select id from ActionType where code='4500' and deleted='0') and deleted=0)
and name="Основной клинический диагноз";
''',
u'''
...
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='1_9_02' and deleted='0')
...
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='4507' and deleted='0')
...
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='1_8_5' and deleted='0')
and name="Стадия опухолевого процесса";
''',
u'''
UPDATE `ActionPropertyType` SET `code`='tumorStage'
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='1_7_1' and deleted='0')
and name="Стадия опухолевого процесса";
''',
u'''
UPDATE `ActionPropertyType` SET `code`='tumorStage'
WHERE `actionType_id` IN (SELECT id FROM ActionType WHERE code='1_7_2' and deleted='0')
and name="Стадия опухолевого процесса";
''',
