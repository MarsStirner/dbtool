...
__doc__ = '''\
Конвертирование значений ЧД из строкового представления в тип Double.
Для каждого типа свойства действия с именем t создается свойство типа действия t
Для каждого значения ЧД из ActionProperty_String
...
def upgrade(conn):
    ...
    # Выбираем строковые значения для свойства ЧДД
